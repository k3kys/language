...
var getAll = function (Model, popOptions) {
    return middlewares_1.catchAsync(function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var doc;
        return __generator(this, function (_a) {
            doc = Model.find({});
            if (!doc) {
                throw new errors_1.BadRequestError("No document found");
            }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    doc = _a.sent();
                    if (!doc) {
                        throw new errors_1.BadRequestError("No document found with that ID");
                    }
                    res.status(http_status_codes_1.StatusCodes.OK).json({
                        status: 'success',
                        data: {
